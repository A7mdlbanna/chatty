                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Directionality(
                                                  textDirection: chat.getDirection(message.messageContent),
                                                  child: Text(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          if (chat.msgController.text.isNotEmpty) {
                            Message? message = Message(userName: auth.userName!, messageContent: chat.msgController.text, time: DateTime.now());
